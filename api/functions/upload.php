...
try {
    $sql = "INSERT INTO arquivos (nome_original, nome_salvo, tipo, tamanho, caminho, usuario_id) 
            VALUES (:nome_original, :nome_salvo, :tipo, :tamanho, :caminho, :usuario_id)";
    ...
    $stmt->execute([
        ...
        ':tipo' => $tipo,
        ':tamanho' => $tamanho,
        ':caminho' => '/Certificados/uploads/' . $nomeSalvo,
